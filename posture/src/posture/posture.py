...
def main():
    ...
    posture.mirror_posture('right_arm', trajectory)
    ...
    posture.add_posture('right_arm','test',goal.trajectory)
    posture.add_posture('right_arm','tutu',goal.trajectory)
    posture.add_posture('left_arm','test',goal.trajectory)
    posture.add_posture('left_arm','titi',goal.trajectory)
    
    posture.save_postures("./mytest.yaml")
